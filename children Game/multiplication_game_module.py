...
class MultiplicationGame:
    def __init__(self, root):
        self.root = root
        self.root.title("Multiplication Adventure")
        ...
        self.title_label = tk.Label(root, text="Multiplication Adventure", font=("Comic Sans MS", self.font_size, "bold"), fg="blue", bg='lightgreen')
    ...
    def update_heart_labels(self):
        heart_icon = "❤️"  # Use a single heart character
